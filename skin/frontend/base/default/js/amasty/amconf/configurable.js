...
Product.Config.prototype.updateData = function(key)
{
    ...
    { 
        ...
        this.updateSimpleData('description', '.box-description div, #product_tabs_description_tabbed_contents div', key);
        ...
        if (true == confData.getDefault('set'))
        {
            ...
            this.getDefaultSimpleData('description', '.box-description div, #product_tabs_description_tabbed_contents div');
