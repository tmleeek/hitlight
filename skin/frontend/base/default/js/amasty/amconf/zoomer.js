    ...
    loadZoom: function() {
        ...
        if(this.generalSettings['lightbox_enable'] === "1"  && $("amasty_zoom")) {
            ...
            if(560 > windowWidth){
                ...
                jQuery("#amasty_zoom").parent().append('<div id="amasty_zoom_fix" style="position: absolute;top:0; background-color: transparent; z-index: 10; width: ' + width + 'px; height: ' + height + 'px;"></div>')
