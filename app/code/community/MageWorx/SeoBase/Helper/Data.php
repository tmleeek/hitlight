...
class MageWorx_SeoBase_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return Mage::getStoreConfigFlag('mageworx_seo/seobase/enabled', $storeId);
    }
    ...
    public function getProductCanonicalType($storeId = null)
    {
        ...
        return Mage::getStoreConfig('mageworx_seo/seobase/product_canonical_url', $storeId);
    }
    ...
    {
        return Mage::getStoreConfig('mageworx_seo/seobase/trailing_slash', $storeId);
    }

    public function cropTrailingSlashForHomePageUrl($storeId = null)
    {
        return Mage::getStoreConfigFlag('mageworx_seo/seobase/trailing_slash_home_page', $storeId);
    }
