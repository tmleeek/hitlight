...
class MageWorx_SeoBase_Block_Adminhtml_System_Config_Frontend_Alternate_Selftest extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        $this->setElement($element);

        if (Mage::helper('mageworx_seobase/alternate')->getAlternateScope() == 'website') {
    ...
    protected function _getSource()
    {
        ...
        foreach ($allStores as $store) {
            ...
            $alternateProductCodes = Mage::helper('mageworx_seobase/alternate')->getAlternateRawCodes('product',
                $store->getStoreId());
            ...
            $alternateCategoryCodes = Mage::helper('mageworx_seobase/alternate')->getAlternateRawCodes('category',
                $store->getStoreId());
            ...
            $alternateCmsCodes = Mage::helper('mageworx_seobase/alternate')->getAlternateRawCodes('cms', $store->getStoreId());
    ...
    protected function _markDuplicateData(&$data, $type, $websiteId, $code)
    {
        ...
        foreach ($data as $webId => $website) {
            if (Mage::helper('mageworx_seobase/alternate')->getAlternateScope() == 'website' && $webId != $websiteId) {
                continue;
            }
