...
class Studioforty9_Recaptcha_Model_Source_Routes
{
    ...
    public function toOptionArray()
    {
        ...
        $routes->add('sales_guest_form', Mage::helper('studioforty9_recaptcha')->__('Returns and Exchanges'));
//	    $routes->add('wholesale_customer_form', Mage::helper('studioforty9_recaptcha')->__('Wholesale Request'));
