...
class Hil_Slider_Block_Adminhtml_Slider_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("slider_data") && Mage::registry("slider_data")->getId() ){
				    ...
				    return Mage::helper("slider")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("slider_data")->getId()));
