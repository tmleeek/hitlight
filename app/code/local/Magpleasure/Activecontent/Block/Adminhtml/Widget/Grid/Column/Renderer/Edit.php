...
class Magpleasure_Activecontent_Block_Adminhtml_Widget_Grid_Column_Renderer_Edit
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        if ($slideId = $this->_getValue($row)){
            ...
            $deleteUrl = $this->getUrl('*/admin_slide/edit', array(
            ...
            $button = $this->getLayout()->createBlock('adminhtml/widget_button')
                ...
                'title'     => $this->__('Edit Slide'),
                'onclick'   => "setLocation('{$deleteUrl}'); disabledEventPropagation(event);",
