...
class Magpleasure_Common_Model_Resource_Abstract extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    protected $_hashHelperLenght = 160;
     ...
     * @return $this
     */
    public function setUseHashHelper($useHashHelper, $hashChars = null, $hashLenght = null)
    {
        ...
        if ($hashLenght){
            $this->_hashHelperLenght = $hashLenght;
        }
    ...
    protected function _generateUniqueHash()
    {
        ...
        for ($i = 1;$i <= $this->_hashHelperLenght; $i++){
