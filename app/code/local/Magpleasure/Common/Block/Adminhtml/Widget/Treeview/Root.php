...
class Magpleasure_Common_Block_Adminhtml_Widget_Treeview_Root extends Magpleasure_Common_Block_Adminhtml_Template
{
     ...
     * Root Collection
     *
     * @return Magpleasure_Common_Model_Resource_Treeview_Collection_Abstract
     */
    public function getRootCollection()
    {
        /** @var Magpleasure_Common_Model_Resource_Treeview_Collection_Abstract $collection */
        $collection = Mage::getModel($this->getModel())->getCollection();
    ...
    public function getTreeHtml()
    {
        ...
        if ($tree){
            $tree
                ->setRootCollection($this->getRootCollection())
