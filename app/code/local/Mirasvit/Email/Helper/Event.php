...
class Mirasvit_Email_Helper_Event extends Mage_Core_Helper_Abstract
{
    ...
    public function getRandomEventArgs()
    {
        ...
        $customerCollection->getSelect()->limit(1, rand(0, $customerCollection->getSize()));
        ...
        $quoteCollection->getSelect()->limit(1, rand(0, $quoteCollection->getSize()));
        ...
        $orderCollection->getSelect()->limit(1, rand(0, $orderCollection->getSize()));
