...
class Mirasvit_Email_Adminhtml_TriggerController extends Mage_Adminhtml_Controller_Action
{
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_title(__('Manage Triggers'), __('Manage Triggers'));
    ...
    public function indexAction()
    {
        ...
        $this->_title(__('Manage Triggers'));
        $this->_initAction();
    ...
    public function editAction()
    {
        ...
        if ($model->getId()) {
            $this->_initAction();
            $this->_title(__("Edit Trigger '%s'", $model->getTitle()));
            ...
            Mage::getSingleton('adminhtml/session')->addError(__('The trigger does not exist.'));
            $this->_redirect('*/*/');
        }
    }
    ...
    public function saveAction()
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            if ($back == 'send') {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(__('Test email was successfully sent'));
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(__('Trigger was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(__('Unable to find trigger to save'));
        $this->_redirect('*/*/');
    }
    ...
    public function deleteAction()
    {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(__('Trigger was successfully deleted'));
        $this->_redirect('*/*/');
    }
    ...
    public function massStatusAction()
    {
        ...
        if (!is_array($triggerIds)) {
             Mage::getSingleton('adminhtml/session')->addError(__('Please select trigger(s)'));
        } else {
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    __('Total of %d record(s) were updated', count($triggerIds))
                );
            } catch (Exception $e) {
                Mage::logException($e);
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
    ...
    public function massDeleteAction()
    {
        ...
        if (!is_array($triggerIds)) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    __('Total of %d record(s) were deleted', count($triggerIds))
                );
            } catch (Exception $e) {
                Mage::logException($e);
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
    ...
    public function massSendAction()
    {
        ...
        if (!is_array($triggerIds)) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    __('Total of %d email(s) were sent', count($triggerIds))
                );
            } catch (Exception $e) {
                Mage::logException($e);
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
