...
class Mage_Catalog_Block_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Abstract
{
	...
	public function getJsonProductTrue() {
		foreach ($this->getAllowProducts() as $product) {
			...
			foreach ($this->getAllowAttributes() as $attribute) {
				...
				if (!isset($options[$attributeValue])) {
					$options[$attributeValue] = array();
				}
				$options[$attributeValue][] = $_productID;
			}
		}
    ...
    public function getJsonConfig()
    {
	    ...
	    $_arrayProduct = array();
	    foreach ($this->getAllowProducts() as $product) {
		    array_push($_arrayProduct, $product->getId());
	    }
	    ...
	    foreach ($this->getAllowProducts() as $product) {
		    foreach ($this->getAllowAttributes() as $attribute) {
			    ...
			    $options[$productAttributeId][$attributeValue] = $_arrayProduct;
		    }
	    }
