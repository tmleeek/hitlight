 ...
 */
class Magegiant_Onestepcheckout_Model_Resource_Sales_Quote extends Magegiant_Onestepcheckout_Model_Resource_Sales_Abstract
{
    /**
    ...
    {
        $this->_init('onestepcheckout/sales_quote', 'entity_id');
    }
}
