 ...
 */
class Magegiant_Onestepcheckout_Model_Resource_Sales_Order_Address
    extends Magegiant_Onestepcheckout_Model_Resource_Sales_Address_Abstract
{
    /**
    ...
    {
        $this->_init('onestepcheckout/sales_order_address', 'entity_id');
    }
}
