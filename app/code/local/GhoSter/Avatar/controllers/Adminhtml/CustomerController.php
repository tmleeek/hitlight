...
class GhoSter_Avatar_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController {
    /*
    ...
    public function viewfileAction() {
        ...
        if (strpos($file, 'ghoster_avatar') !== false) {
            $path = Mage::getBaseDir('media') . DS . 'ghoster_avatar' . DS;
        } else {
