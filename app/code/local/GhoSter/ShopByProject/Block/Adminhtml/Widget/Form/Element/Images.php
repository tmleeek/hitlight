<?php
class GhoSter_ShopByProject_Block_Adminhtml_Widget_Form_Element_Images extends Mage_Adminhtml_Block_Widget
    ...
    protected function _prepareLayout(){
        $addBtn = $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
            'label'     => Mage::helper('ghoster_shopbyproject')->__('Add Image'),
