<?php
class GhoSter_ShopByProject_Block_Adminhtml_Widget_Form_Element_Browser extends Mage_Adminhtml_Block_Widget
    ...
    public function __construct(){
        parent::__construct();
        $this->setTemplate('ghoster/adminhtml/widget/form/element/browser.phtml');
    }
    ...
    protected function _prepareLayout(){
        ...
        $browserBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => '...',
            'title'     => Mage::helper('ghoster_shopbyproject')->__('Click to browser media'),
            'type'      => 'button',
        ...
        $clearBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => 'x',
            'title'     => Mage::helper('ghoster_shopbyproject')->__('Click to clear value'),
            'type'      => 'button',
