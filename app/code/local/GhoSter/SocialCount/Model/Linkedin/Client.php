 ...
 * Time: 9:03 AM
 */
class GhoSter_SocialCount_Model_Linkedin_Client
{
    const COUNT_SERVICE_URI = 'https://www.linkedin.com/countserv/count/share';
     ...
     * @throws Exception
     * @throws GhoSter_SocialCount_Model_Linkedin_Exception
     */
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if ($response->isError()) {
            ...
            if (($status == 400 || $status == 401)) {
                ...
                //throw new GhoSter_SocialCount_Model_Linkedin_Exception($message);
