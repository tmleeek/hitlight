<?php
class GhoSter_Common_Block_Adminhtml_Widget_Form_Element_Browser extends Mage_Adminhtml_Block_Widget
    ...
    protected function _prepareLayout(){
        ...
        $browserBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => '...',
            'title'     => Mage::helper('ghoster_common')->__('Click to browser media'),
            'type'      => 'button',
        ...
        $clearBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => 'x',
            'title'     => Mage::helper('ghoster_common')->__('Click to clear value'),
            'type'      => 'button',
