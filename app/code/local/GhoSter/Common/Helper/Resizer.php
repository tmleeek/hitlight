...
class GhoSter_Common_Helper_Resizer extends Mage_Core_Helper_Abstract {
    ...
    /**
     * Current model
     * @var GhoSter_Common_Model_Media_Image
     */
    protected $_model;
    ...
    /**
     * Helper
     * @return GhoSter_Common_Helper_Data
     */
    protected function _commonHelper()
    {
        return Mage::helper('ghoster_common');
    }
     ...
     *
     * @param GhoSter_Common_Model_Media_Image $model
     * @return GhoSter_Common_Helper_Resizer
     */
     ...
     *
     * @return GhoSter_Common_Model_Media_Image
     */
    ...
    public function init($imageFile)
    {
        ...
        /** @var GhoSter_Common_Model_Media_Image $mediaImageModel */
        $mediaImageModel = Mage::getModel('testimony/media_image');
