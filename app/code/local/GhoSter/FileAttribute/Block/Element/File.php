<?php
/**
 * GhoSter FileAttribute Block Element File
 *
 * @category    GhoSter
 ...
 */
class GhoSter_FileAttribute_Block_Element_File extends Varien_Data_Form_Element_Abstract
{
    /**
     * Constructor
     *
    ...
    protected function _getDeleteCheckbox()
    {
        $html = '';
        if ($this->getValue()) {
            $label = Mage::helper('ghoster_fileattribute')->__('Delete File');
