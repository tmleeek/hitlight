...
*/
class Evince_Customattribute_Block_Adminhtml_Customer_Attribute_Edit_Tab_Options extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('customattribute/attribute/options.phtml');
    }
