...
*/
class Evince_Customattribute_Block_Adminhtml_Customer_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('customattribute/adminhtml_customer_attribute_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('labels', array(
            ...
            'content'   => $this->getLayout()->createBlock('customattribute/adminhtml_customer_attribute_edit_tab_options')->toHtml(),
        ));
        ...
        if ('multiselectimg' == $model->getFrontendInput() || 'selectimg' == $model->getFrontendInput())
        {
            $this->addTab('images', array(
                ...
                'content'   => $this->getLayout()->createBlock('customattribute/adminhtml_customer_attribute_edit_tab_images')->toHtml(),
            ));
        }
