...
*/
class Evince_Customattribute_Block_Adminhtml_Customer_Attribute_Edit_Tab_Depends extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('customattribute/attribute/depends.phtml');
    }
