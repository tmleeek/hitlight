...
*/
class Evince_Customattribute_Block_Data_Form_Element_Multiselectimg extends Varien_Data_Form_Element_Abstract
{
    ...
    protected function _optionToHtml($option, $selected)
    {
        ...
        if (Mage::helper('customattribute')->getAttributeImageUrl($option['value']))
        {
            $html .= '<img src="' . Mage::helper('customattribute')->getAttributeImageUrl($option['value']) . '" style="clear: right;" />';
        }
        $cssClass = '';
