...
Evince_Customerattr_Block_Rewrite_Sales_Order_View_Info
 */
class Evince_Customattribute_Block_Rewrite_Sales_Order_View_Info extends Mage_Adminhtml_Block_Sales_Order_View_Info
{
    public function getCustomerAccountData()
    {
        ...
        if ($customerId = $this->getOrder()->getCustomerId())
        {
            ...
            $alias = Mage::helper('customattribute')->getProperAlias($attributes->getSelect()->getPart('from'), 'eav_attribute');
            ...
            $alias = Mage::helper('customattribute')->getProperAlias($attributes->getSelect()->getPart('from'), 'customer_eav_attribute');
