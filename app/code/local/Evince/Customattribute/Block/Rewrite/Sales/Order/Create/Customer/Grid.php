...
*/
class Evince_Customattribute_Block_Rewrite_Sales_Order_Create_Customer_Grid extends Mage_Adminhtml_Block_Sales_Order_Create_Customer_Grid
{
    ...
    public function __construct()
    {
        ...
        if (Mage::getStoreConfig('customattribute/general/select_grid'))
        {
            $this->_attributeCollection = Mage::getModel('customer/attribute')->getCollection();
            $alias = Mage::helper('customattribute')->getProperAlias($this->_attributeCollection->getSelect()->getPart('from'), 'eav_attribute');
            ...
            $alias = Mage::helper('customattribute')->getProperAlias($this->_attributeCollection->getSelect()->getPart('from'), 'customer_eav_attribute');            
            ...
            if ($inputType = $attribute->getFrontend()->getInputType())
            {
                ...
                if ('file' == $attribute->getTypeInternal()) {
                    $this->addColumn($attribute->getAttributeCode(), array (
                        ...
                        'index'        => $attribute->getAttributeCode(),
                        'align'        => 'center',
                        'renderer'     => 'customattribute/adminhtml_renderer_file',
                    ));
                }
            }
        }
