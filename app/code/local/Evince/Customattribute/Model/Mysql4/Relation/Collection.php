...
*/ 
class Evince_Customattribute_Model_Mysql4_Relation_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    {
    	 $this->getSelect()
    	 		->joinInner(array('v'=> $this->getTable('customattribute/details')), 'main_table.id = v.relation_id', array('v.attribute_id'))
    ...
    public function getElementsRelation()
    {
    	 $this->getSelect()
    	 		...
    	 		->joinInner(array('v'=> $this->getTable('customattribute/details')), 'main_table.id = v.relation_id', null)
