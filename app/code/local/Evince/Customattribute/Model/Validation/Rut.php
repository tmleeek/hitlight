...
*/
class Evince_Customattribute_Model_Validation_Rut
{
    ...
    public function getValues()
    {
        $values = array('value' => $this->_value,
                        'label' => Mage::helper('customattribute')->__('RUT code validation')
                        );
        return $values;
    }
    ...
    {
        $message = Mage::helper('customattribute')->__('Please use the value in the RUT format');
