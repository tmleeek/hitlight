...
*/
class Evince_Customattribute_Model_Validation_Royalty
{
    ...
    public function getValues()
    {
        $values = array('value' => $this->_value,
                        'label' => Mage::helper('customattribute')->__('Royalty Card Number')
                        );
        return $values;
    }
    ...
    {
        $message = Mage::helper('customattribute')->__('Sorry, that is not a valid card number');
