...
*/ 
class Evince_Customattribute_Model_Details extends Mage_Core_Model_Abstract
{
    public function _construct()
    {
        parent::_construct();
        $this->_init('customattribute/details');
    }
    ...
    public function fastDelete($ids)
    {
        ...
        $table = Mage::getSingleton('core/resource')->getTableName('customattribute/details');        
