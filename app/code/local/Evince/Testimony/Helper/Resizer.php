<?php
class Evince_Testimony_Helper_Resizer extends Mage_Core_Helper_Abstract {
    ...
    /**
     * Current model
     * @var Evince_Testimony_Model_Media_Image
     */
    protected $_model;
     ...
     *
     * @return Evince_Testimony_Helper_Resizer
     */
     ...
     *
     * @param Evince_Testimony_Model_Media_Image $model
     * @return Evince_Testimony_Helper_Resizer
     */
    ...
    public function init($imageFile)
    {
        ...
        /** @var Evince_Testimony_Model_Media_Image $mediaImageModel */
