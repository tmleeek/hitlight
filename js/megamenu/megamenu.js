...
if (mbmenu) {
    anchor.bind('click', function () {
        ...
        if ($_this.hasClass('flag')) {
            $_this.removeClass('flag');
            $_this.addClass('glyphicon-align-justify');
            $_this.removeClass('glyphicon-remove');
            $_this.parent().removeClass('show-menu');
            mbmenu.fadeOut(200);
        } else {
            $_this.addClass('flag');
            $_this.removeClass('glyphicon-align-justify');
    ...
    if (mobile_effect == 1) {
        mclick.bind('click', function () {
            ...
            if ($_this.hasClass('flag')) {
                $_this.removeClass('flag');
                $_this.children('span').removeClass('fa-angle-down');
                $_this.children('span').addClass('fa-angle-right');
                $_this.next().fadeOut(200);
            } else {
                mclick.removeClass('flag');
                mclick.children('span').removeClass('fa-angle-down');
                mclick.next().slideUp(200);
                $_this.addClass('flag');
                $_this.children('span').addClass('fa-angle-down');
                $_this.children('span').removeClass('fa-angle-right');
